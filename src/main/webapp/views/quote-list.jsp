                ...
                <tbody class="divide-y divide-gray-100">
                    <c:forEach var="q" items="${listQuotes}">
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-600">${q.stage}</td>
                            <td class="px-6 py-4 text-right font-bold text-gray-800">
                                <fmt:formatNumber value="${q.grandTotal}" type="currency" currencySymbol="đ" />
                            </td>
                            <td class="px-6 py-4 text-center">
                                <a href="quotes?action=edit&id=${q.id}" class="text-blue-500 hover:text-blue-700 mr-3"><i class="fa-solid fa-pen"></i></a>
                                <a href="quotes?action=delete&id=${q.id}" class="text-red-400 hover:text-red-600" onclick="return confirm('Xóa báo giá này?')"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
